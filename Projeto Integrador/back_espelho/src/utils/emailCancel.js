...
const verificarEmail = {
    emailCancel: async (agendamento) => {
        // Criando o conteúdo HTML para o email
        console.log(agendamento);
        const msg = {
            to: agendamento.email_aluno, // Destinatário
                ...
                <html>
                    ...
                    <body>
                        <div class="email-container">
                            ...
                            <div class="footer">
                                <p>Seu agendamento foi cancelado pelo profissional. Tente remarcar para outro dia ou horário.</p>
                            </div>
                        </div>
                    </body>
                </html>
