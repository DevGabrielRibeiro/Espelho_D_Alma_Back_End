...
const verificarEmail = {
    email: async (agendamento) => {
        ...
        const msg = {
            to: 'lucas.manete2403@gmail.com', // Destinatário
                ...
                <html>
                    ...
                    <body>
                        <div class="email-container">
                            ...
                            <div class="card">
                                <p><strong>Nome do Profissional:</strong>${agendamento.profissional}</p>
                                <p><strong>Nome do Aluno:</strong>${agendamento.nome_aluno}</p>
                                <p><strong>Unidade de Atendimento:</strong>${agendamento.nome}</p>
                                <p><strong>Data do Atendimento:</strong> ${agendamento.dia_agendamento}</p>
